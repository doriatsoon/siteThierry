...
include 'text/ConstantesMethodologie.php5';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
  ...
  <head>
    ...
    <meta name="title" content="Espace Forme - Montfermeil - Gagny - M�thodologie"/>
  ...
  <body>
    ...
    <div id="content">
      ...
      <div id="content_left">
        <?php makeContentBoxOther(ConstantesMethodologie::$titleEchauffement, ConstantesMethodologie::$messageEchauffement, ConstantesMethodologie::$idEchauffement); ?>
        <?php makeContentBoxOther(ConstantesMethodologie::$titleTechniqueMouvement, ConstantesMethodologie::$messageTechniqueMouvement, ConstantesMethodologie::$idTechniqueMouvement); ?>
        <?php makeContentBoxOther(ConstantesMethodologie::$titleRepos, ConstantesMethodologie::$messageRepos, ConstantesMethodologie::$idRepos); ?>
        <?php makeContentBoxOther(ConstantesMethodologie::$titleOrdreEntrainement, ConstantesMethodologie::$messageOrdreEntrainement, ConstantesMethodologie::$idOrdreEntrainement); ?>
      </div>
